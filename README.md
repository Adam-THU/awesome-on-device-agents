...
| LLM-Powered GUI Agents in Phone Automation: Surveying Progress and Prospects           | 2025-05 | arXiv | [Paper](https://arxiv.org/abs/2504.19838)           |
| Mobile Edge Intelligence for Large Language Models: A Contemporary Survey              | 2025-03 | COMST | [Paper](https://doi.org/10.1109/COMST.2025.3527641) |
| On-Device Language Models: A Comprehensive Review                                      | 2024-08 | arXiv | [Paper](https://arxiv.org/abs/2409.00088)           |
| Personal LLM Agents: Insights and Survey about the Capability, Efficiency and Security | 2024-01 | arXiv | [Paper](https://arxiv.org/abs/2401.05459)           |

### 2. Efficient On-device Inference

| Paper                                                                                    |    Date | Venue   | Link                                                               |
| ---------------------------------------------------------------------------------------- | ------- | ------- | ------------------------------------------------------------------ |
| Scaling LLM Test-Time Compute with Mobile NPU on Smartphones                             | 2026-04 | EuroSys | [Paper](https://doi.org/10.1145/3767295.3769382)                   |
...
| EdgeMoE: Empowering Sparse Large Language Models on Mobile Devices                       | 2025-08 | TMC     | [Paper](https://doi.org/10.1109/TMC.2025.3546466)                  |
| Neuralink: Fast on-Device LLM Inference with Neuron Co-Activation Linking                | 2025-08 | ASPLOS  | [Paper](https://doi.org/10.1145/3676642.3736114)                   |
| CLONE: Customizing LLMs for Efficient Latency-Aware Inference at the Edge                | 2025-07 | ATC     | [Paper](https://www.usenix.org/conference/atc25/presentation/tian) |
| EdgeLLM: Fast On-Device LLM Inference With Speculative Decoding                          | 2025-04 | TMC     | [Paper](https://doi.org/10.1109/TMC.2024.3513457)                  |
| Fast On-device LLM Inference with NPUs                                                   | 2025-03 | ASPLOS  | [Paper](https://doi.org/10.1145/3669940.3707239)                   |
| T-MAC: CPU Renaissance via Table Lookup for Low-Bit LLM Deployment on Edge               | 2025-03 | EuroSys | [Paper](https://doi.org/10.1145/3689031.3696099)                   |
| PowerInfer-2: Fast Large Language Model Inference on a Smartphone                        | 2024-06 | arXiv   | [Paper](https://arxiv.org/abs/2406.06282)                          |
...
| AutoDroid-V2: Boosting SLM-based GUI Agents via Code Generation                 | 2025-06 | MobiSys | [Paper](https://doi.org/10.1145/3711875.3729134) |
| AutoDroid: LLM-powered Task Automation in Android                               | 2024-05 | MobiCom | [Paper](https://doi.org/10.1145/3636534.3649379) |

### 4. Security

| Paper                                                                             |    Date | Venue   | Link                                             |
| --------------------------------------------------------------------------------- | ------- | ------- | ------------------------------------------------ |
| Mobile GUI Agents under Real-world Threats: Are We There Yet?                     | 2026-04 | MobiSys | [Paper](https://doi.org/10.1145/3745756.3809249) |
...
| Paper                                                                                |    Date | Venue | Link                                      |
| ------------------------------------------------------------------------------------ | ------- | ----- | ----------------------------------------- |
| MANA: Towards Efficient Mobile Ad Detection via Multimodal Agentic UI Navigation     | 2026-03 | arXiv | [Paper](https://arxiv.org/abs/2603.20351) |
| LLM-Explorer: Towards Efficient and Affordable LLM-based Exploration for Mobile Apps | 2025-05 | arXiv | [Paper](https://arxiv.org/abs/2505.10593) |
...
| Paper                                                                            |    Date | Venue | Link                                                                                                                       |
| -------------------------------------------------------------------------------- | ------- | ----- | -------------------------------------------------------------------------------------------------------------------------- |
| AndroidLab: Training and Systematic Benchmarking of Android Autonomous Agents    | 2025-07 | ACL   | [Paper](https://aclanthology.org/2025.acl-long.107/)                                                                       |
| AndroidWorld: A Dynamic Benchmarking Environment for Autonomous Agents           | 2025-04 | ICLR  | [Paper](https://proceedings.iclr.cc/paper_files/paper/2025/hash/01a83bc2f2732a58e6aa731e659e7101-Abstract-Conference.html) |
| MobileAgentBench: An Efficient and User-Friendly Benchmark for Mobile LLM Agents | 2024-06 | arXiv | [Paper](https://arxiv.org/abs/2406.08184)                                                                                  |
...
| Small Language Models are the Future of Agentic AI                   | 2025-09 | arXiv              | [Paper](https://arxiv.org/abs/2506.02153)           |
